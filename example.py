from vahar.datasets.sfu_imu import SFUParquet, SFUConst, SFUNpyWindow

sfu_parquet_folder = 'parquet_dataset/SFU-IMU'

# process raw dataset to the intended parquet format
SFUParquet(
    raw_folder='raw_dataset/SFU-IMU',
    destination_folder=sfu_parquet_folder,
    sampling_rates={SFUConst.MODAL: 50}
).run()

# sliding window
windows = SFUNpyWindow(
    parquet_root_dir=sfu_parquet_folder,
